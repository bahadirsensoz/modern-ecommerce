      ...
      <div className="page-shell flex items-center justify-between gap-6 py-3">
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-lg font-semibold text-gray-900">MyShop</p>
          </div>
        </button>
        ...
        <div className="flex items-center gap-3">
          {isAuthenticated && (
            <button
              ...
              className="group relative flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-800 transition hover:border-gray-300 hover:bg-gray-50"
              title="Favorites"
            >
          ...
          {isAuthenticated ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2 text-left text-gray-800 transition hover:border-gray-300 hover:bg-gray-50"
              >
              ...
              {open && (
                <div className="absolute right-0 mt-3 w-56 rounded-xl border border-gray-200 bg-white p-2 shadow-lg">
                  <button
                    ...
                    className="flex w-full items-center justify-between rounded-lg px-4 py-3 text-sm font-semibold text-gray-800 transition hover:bg-gray-50"
                  >
